 ...
 * @property {String} this.customerPhone - the customer (billed to) phone
 ...
 * @property {String} this.billingZip - the billing zipcode
 ...
 * @property {String} this.shippingZip - the shipping zipcode
...
/**
 * setEventually the customer phone
 * @method
 * @param {String} phone - the customer phone
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withCustomerPhone = setEventually('customerPhone');
