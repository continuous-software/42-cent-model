 ...
 * @property {String} this.cvv2 - the cvv/cvv2/etc code
 */
 ...
 * @method
 * @param {String | Number} cvv2 - a string for the cvv/cvv2/etc code
 * @returns {CreditCard} returns the instance
 */
CreditCard.prototype.withCvv2 = setEventually('cvv2');

/**
 * setEventually the card holder name
 * @method
 * @param {String} cardHolder - a string for the card holder name of the card
 * @returns {CreditCard} returns the instance
 */
CreditCard.prototype.withCardHolder = setEventually('cardHolder');
