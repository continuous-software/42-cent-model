 ...
 * @property {String} this.billingStateRegion - the billing state
 * @property {String} this.billingState - the billing state (alias)
 * @property {String} this.billingRegion - the billing state (alias)
 ...
 * @property {String} this.shippingStateRegion - the shipping state
 * @property {String} this.shippingState - the shipping state (alias)
 * @property {String} this.shippingRegion - the shipping state (alias)
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withBillingStateRegion = setEventually('billingState');

/**
 * setEventually the billing state (alias)
 * @method
 * @param {String} state - the billing state
 * @returns {Prospect} returns the instance
 */
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withBillingRegion = setEventually('billingState');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingStateRegion = setEventually('shippingState');

/**
 * setEventually the shipping state (alias)
 * @method
 * @param {String} state - the shipping state
 * @returns {Prospect} returns the instance
 */
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingRegion = setEventually('shippingState');
