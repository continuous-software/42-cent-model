...
Prospect.prototype.withProfileId = set('profileId');
 ...
 */
Prospect.prototype.withCustomerFirstName = set('customerFirstName');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withCustomerLastName = set('customerLastName');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withCustomerEmail = set('customerEmail');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withBillingAddress = set('billingAddress');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withBillingCity = set('billingCity');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withBillingState = set('billingState');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withBillingCountry = set('billingCountry');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingFirstName = set('shippingFirstName');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingLastName = set('shippingLastName');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingAddress = set('shippingAddress');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingCity = set('shippingCity');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingState = set('shippingState');
 ...
 * @returns {Prospect} returns the instance
 */
Prospect.prototype.withShippingCountry = set('shippingCountry');
