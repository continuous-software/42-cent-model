 ...
 */
CreditCard.prototype.withCreditCardNumber = set('creditCardNumber');
 ...
 * @returns {CreditCard} returns the instance
 */
CreditCard.prototype.withExpirationMonth = set('expirationMonth');
 ...
 * @returns {CreditCard} returns the instance
 */
CreditCard.prototype.withExpirationYear = set('expirationYear');
 ...
 * @returns {CreditCard} returns the instance
 */
CreditCard.prototype.withCvv = set('cvv');
